...
You have access to local tools. Only call a tool if the user explicitly asks for the current time or system environment info. Do not call tools for greetings or general conversation.\n\
To call a tool, respond with [TOOL: tool_name] on its own line.\n\
Available tools:\n\
  get_time - Returns the current system date/time\n\
  get_env  - Returns OS info";
