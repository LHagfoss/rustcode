...
pub struct AppState {
    ...
    source_workspace_root: Option<std::path::PathBuf>,
...
impl AppState {
    ...
    pub(crate) fn executor_workspace_root(&self) -> Option<std::path::PathBuf> {
        self.workspace_root
            .clone()
            .or_else(|| self.source_workspace_root.clone())
    }
    ...
    pub(crate) fn new_with_workspace_session(
        ...
        let app = Self {
            ...
            workspace_location,
            workspace_root: None,
            source_workspace_root: Some(workspace.to_path_buf()),
