...
pub fn multi_replace_file_content_schema() -> Value {
    serde_json::json!({
        "type": "object", "properties": {
...
pub fn write_to_file_schema() -> Value {
    serde_json::json!({
        "type": "object", "properties": {
...
pub fn delete_file_with_context(
    ...
    crate::with_context(context, || delete_file(args))
}
...
pub fn move_file_with_context(
    ...
    crate::with_context(context, || move_file(args))
}
...
pub fn copy_file_with_context(
    ...
    crate::with_context(context, || copy_file(args))
}
...
pub fn view_file_with_context(
    args: &Value,
    context: &crate::ToolContext,
) -> Result<ViewFileOutput, String> {
    crate::with_context(context, || view_file_output(args))
}
...
pub fn edit_target_and_replacement(args: &Value) -> (Option<String>, Option<String>) {
    (
...
pub fn replace_file_content_with_context(
    args: &Value,
    context: &crate::ToolContext,
) -> Result<String, String> {
    crate::with_context(context, || replace_file_content_tool(args))
}

pub fn normalise_unicode_punctuation(s: &str) -> String {
    s.chars()
        .map(|c| match c {
...
pub fn multi_replace_file_content_with_context(
    args: &Value,
    context: &crate::ToolContext,
) -> Result<String, String> {
    crate::with_context(context, || multi_replace_file_content_tool(args))
}
